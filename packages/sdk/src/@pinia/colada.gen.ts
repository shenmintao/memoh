 ...
 */
export const postPushByIdMutation = (options?: Partial<Options<PostPushByIdData>>): UseMutationOptions<PostPushByIdResponse, Options<PostPushByIdData>, PostPushByIdError> => ({
    mutation: async (vars) => {
        const { data } = await postPushById({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getRuntimesStatusQueryKey = (options: Options<GetRuntimesStatusData>) => createQueryKey('getRuntimesStatus', options);
 ...
 */
export const getRuntimesStatusQuery = defineQueryOptions<Options<GetRuntimesStatusData>, GetRuntimesStatusResponse, GetRuntimesStatusError>((options: Options<GetRuntimesStatusData>) => ({
    key: getRuntimesStatusQueryKey(options),
    query: async (context) => {
        const { data } = await getRuntimesStatus({
            ...options,
            ...context,
            throwOnError: true
        });
...
export const getUsersMePushEndpointsQueryKey = (options?: Options<GetUsersMePushEndpointsData>) => createQueryKey('getUsersMePushEndpoints', options);

/**
 * List personal notification endpoints
 */
export const getUsersMePushEndpointsQuery = defineQueryOptions<Options<GetUsersMePushEndpointsData>, GetUsersMePushEndpointsResponse, GetUsersMePushEndpointsError>((options?: Options<GetUsersMePushEndpointsData>) => ({
    key: getUsersMePushEndpointsQueryKey(options),
    query: async (context) => {
        const { data } = await getUsersMePushEndpoints({
            ...options,
            ...context,
            throwOnError: true
        });
 ...
 */
export const postUsersMePushEndpointsMutation = (options?: Partial<Options<PostUsersMePushEndpointsData>>): UseMutationOptions<PostUsersMePushEndpointsResponse, Options<PostUsersMePushEndpointsData>, PostUsersMePushEndpointsError> => ({
    mutation: async (vars) => {
 ...
 */
export const deleteUsersMePushEndpointsByIdMutation = (options?: Partial<Options<DeleteUsersMePushEndpointsByIdData>>): UseMutationOptions<unknown, Options<DeleteUsersMePushEndpointsByIdData>, Error> => ({
    mutation: async (vars) => {
        const { data } = await deleteUsersMePushEndpointsById({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 */
export const patchUsersMePushEndpointsByIdMutation = (options?: Partial<Options<PatchUsersMePushEndpointsByIdData>>): UseMutationOptions<PatchUsersMePushEndpointsByIdResponse, Options<PatchUsersMePushEndpointsByIdData>, Error> => ({
    mutation: async (vars) => {
        const { data } = await patchUsersMePushEndpointsById({
            ...options,
            ...vars,
            throwOnError: true
        });
...
export const getUsersMePushEndpointsByIdDeliveriesQueryKey = (options: Options<GetUsersMePushEndpointsByIdDeliveriesData>) => createQueryKey('getUsersMePushEndpointsByIdDeliveries', options);

/**
 * List the latest 20 delivery receipts; message bodies are never stored
 */
export const getUsersMePushEndpointsByIdDeliveriesQuery = defineQueryOptions<Options<GetUsersMePushEndpointsByIdDeliveriesData>, GetUsersMePushEndpointsByIdDeliveriesResponse, Error>((options: Options<GetUsersMePushEndpointsByIdDeliveriesData>) => ({
    key: getUsersMePushEndpointsByIdDeliveriesQueryKey(options),
    query: async (context) => {
        const { data } = await getUsersMePushEndpointsByIdDeliveries({
            ...options,
            ...context,
            throwOnError: true
        });
 ...
 */
export const postUsersMePushEndpointsByIdRotateKeyMutation = (options?: Partial<Options<PostUsersMePushEndpointsByIdRotateKeyData>>): UseMutationOptions<PostUsersMePushEndpointsByIdRotateKeyResponse, Options<PostUsersMePushEndpointsByIdRotateKeyData>, Error> => ({
    mutation: async (vars) => {
        const { data } = await postUsersMePushEndpointsByIdRotateKey({
            ...options,
            ...vars,
            throwOnError: true
        });
 ...
 */
export const postUsersMePushEndpointsByIdTestMutation = (options?: Partial<Options<PostUsersMePushEndpointsByIdTestData>>): UseMutationOptions<PostUsersMePushEndpointsByIdTestResponse, Options<PostUsersMePushEndpointsByIdTestData>, PostUsersMePushEndpointsByIdTestError> => ({
    mutation: async (vars) => {
        const { data } = await postUsersMePushEndpointsByIdTest({
            ...options,
            ...vars,
            throwOnError: true
        });
